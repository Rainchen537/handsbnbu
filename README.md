...
将教师总体星级采集与公开评分描述更新为五个独立课堂体验维度、逐维分布及样本数，说明未选择不提交、历史评分原值保留、旧提交关闭、新版不换算教师总分及小U仅读取公开聚合的边界。保留地标五分制、其他数据处理条款和`69c4189`增加的favicon与发布允许列表；正文日期更新为2026年9月13日，三站同步结果由核心项目日志记录。

## 2026-09-15 自动多端同步

记录登录后固定自动同步的个人日程／TA、课程定制和账号习惯范围，不提供用户同步开关；区分原业务本地缓存、加密账号习惯记录、服务端静态加密和端到端加密，保留凭据／学校数据／系统权限边界。更新旧停用迁移、历史删除标记、7／30／60天雷达范围、退出保留与账号完整删除说明；原ME生活、学校会话、地图、小U和治理条款保持。三处公开正文须与同一index.html源及最后更新日期一致，实际部署证据由核心项目日志记录。
